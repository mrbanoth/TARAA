    ...
    <Layout>
      <div className="container mx-auto px-4 sm:px-6 py-6 md:py-8">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-bold">Women's Collection</h1>
            <p className="text-muted-foreground mt-1">
              Handpicked deals for women • {womenProducts.length} products
            </p>
          </div>
        </div>
        ...
        {loading ? (
              ...
              return (
                ...
                >
                  ...
                  <div className="relative w-full h-full">
                    ...
                    {/* Gender Badge */}
                    {product.gender && (
                      <Badge className="absolute top-2 right-2 bg-pink-500/90 text-white capitalize text-xs">
                        {product.gender}
                      </Badge>
                    )}
          ...
          <Card className="p-12 text-center">
            <p className="text-muted-foreground">
              {searchQuery ? "No products found matching your search" : "No women's products available yet. Admin can add products with gender set to 'Women' or 'Unisex'."}
            </p>
          </Card>
        )}
      </div>
